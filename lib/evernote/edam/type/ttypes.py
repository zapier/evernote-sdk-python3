...
class Ad(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.advertiserName = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRING:
          self.imageUrl = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.STRING:
          self.destinationUrl = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.I16:
        ...
        if ftype == TType.STRING:
          self.imageMime = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.STRING:
          self.html = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.DOUBLE:
  ...
  def write(self, oprot):
    ...
    if self.advertiserName is not None:
      ...
      oprot.writeString(self.advertiserName.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.imageUrl is not None:
      oprot.writeFieldBegin('imageUrl', TType.STRING, 5)
      oprot.writeString(self.imageUrl.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.destinationUrl is not None:
      oprot.writeFieldBegin('destinationUrl', TType.STRING, 6)
      oprot.writeString(self.destinationUrl.encode('utf-8'))
      oprot.writeFieldEnd()
    ...
    if self.imageMime is not None:
      ...
      oprot.writeString(self.imageMime.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.html is not None:
      oprot.writeFieldBegin('html', TType.STRING, 11)
      oprot.writeString(self.html.encode('utf-8'))
      oprot.writeFieldEnd()
