      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i213 in range(_size209):
            _elem214 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for iter215 in self.success:
        oprot.writeString(iter215.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.userException is not None:
      oprot.writeFieldBegin('userException', TType.STRUCT, 1)
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i220 in range(_size216):
            _elem221 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.noteGuids is not None:
      ...
      for iter222 in self.noteGuids:
        oprot.writeString(iter222.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i241 in range(_size237):
            _elem242 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.recipients is not None:
      ...
      for iter243 in self.recipients:
        oprot.writeString(iter243.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
