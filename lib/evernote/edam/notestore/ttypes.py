...
class AdParameters(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 2:
        if ftype == TType.STRING:
          self.clientLanguage = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.LIST:
        ...
        if ftype == TType.MAP:
          ...
          for _i161 in range(_size157):
            _key162 = iprot.readString().decode('utf-8')
            _val163 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.clientLanguage is not None:
      ...
      oprot.writeString(self.clientLanguage.encode('utf-8'))
      oprot.writeFieldEnd()
    ...
    if self.clientProperties is not None:
      ...
      for kiter165,viter166 in self.clientProperties.items():
        ...
        oprot.writeString(viter166.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i177 in range(_size173):
            _elem178 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.toAddresses is not None:
      ...
      for iter179 in self.toAddresses:
        oprot.writeString(iter179.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.ccAddresses is not None:
      ...
      for iter180 in self.ccAddresses:
        oprot.writeString(iter180.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
